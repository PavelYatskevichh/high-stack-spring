...
VALUES
    ...
    1, 'Added recent statistics to support key points in the article.',
    '=39', '=98', '=38	-4	+macronutrients	=62', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222224', '11111111-1111-1111-1111-111111111113',
    2, 'Simplified complex explanations to make the content more accessible to a broader audience.',
    '=39', '=98', '=52	-4	+,	=25	+s, and incorporating a variety of food	=33', CURRENT_TIMESTAMP),
    ...
    '=36', '=97', '=114	+ and achievements	=1', CURRENT_TIMESTAMP),
