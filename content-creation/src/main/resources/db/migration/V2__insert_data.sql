...
VALUES
    ...
    'Healthy eating involves understanding macronutrients, controlling portion sizes, and incorporating a variety of foods. Learn the key principles here.',
    ...
    'A strong resume can open doors to your dream job. Follow these ten steps to create one that highlights your skills and achievements.',
    ...
    'Quantum physics explores the behavior of matter and energy at the smallest scales. Concepts like superposition and entanglement are covered here.',
    '00000000-0000-0000-0000-000000000001', 'DRAFT', CURRENT_TIMESTAMP),
    ...
    'Emotional intelligence includes self-awareness, empathy, and communication skills. This guide helps you understand and develop these traits.',
    '00000000-0000-0000-0000-000000000001', 'SUBMITTED', CURRENT_TIMESTAMP);
...
VALUES
    ...
    ('22222222-2222-2222-2222-222222222223', '11111111-1111-1111-1111-111111111113', 1,
    'Added recent statistics to support key points in the article.', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222224', '11111111-1111-1111-1111-111111111113', 2,
    'Simplified complex explanations to make the content more accessible to a broader audience.', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222225', '11111111-1111-1111-1111-111111111114', 1,
    'Removed redundant paragraphs and tightened the narrative for better flow.', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222226', '11111111-1111-1111-1111-111111111114', 2,
    'Incorporated feedback from the author to clarify ambiguous statements.', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222227', '11111111-1111-1111-1111-111111111115', 1,
    'Added real-life examples to illustrate the main ideas effectively.', CURRENT_TIMESTAMP),
    ('22222222-2222-2222-2222-222222222228', '11111111-1111-1111-1111-111111111116', 1,
    'Updated references and sources to ensure the article reflects the latest developments.', CURRENT_TIMESTAMP);
