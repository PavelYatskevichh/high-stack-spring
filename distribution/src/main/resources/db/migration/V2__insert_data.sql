INSERT INTO distribution.publications (id, content_item_id, title, body, published_at)
VALUES
    ('44444444-4444-4444-4444-444444444441', '11111111-1111-1111-1111-111111111112', 'The Future of Renewable Energy',
    ...
    ('44444444-4444-4444-4444-444444444442', '11111111-1111-1111-1111-111111111113', '5 Strategies for Effective Team Management',
    ...
    ('44444444-4444-4444-4444-444444444443', '11111111-1111-1111-1111-111111111114', 'The Impact of AI on Healthcare',
...
INSERT INTO distribution.feedbacks (id, publication_id, audience_id, rating, comment, submitted_at)
VALUES
